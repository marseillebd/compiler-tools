...
And ofc I've started this "log book" where I keep track of my progress as it happens.
This stuff (in `NOTES/logbook`) should never be modified after committed.
Also, it shouldn't be committed until the end of the day.

I've also got a script to edit the current log book entry.

### Future Work

Start a blog: summarize and present my work periodically, drawing on the content of the log books.
This would be like a devlog.

Write a script to check on the log book/devlog:
- are there commits after the last log book?
- what log book entries aren't covered by a devlog?

If more people start working on this, I may need to separate the log books by author.
...
The README needs to point to the log book/blog.
